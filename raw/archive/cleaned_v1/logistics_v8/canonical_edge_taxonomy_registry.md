# Canonical Edge Taxonomy Registry — Logistics v4

This compact registry is derived from the scoped canonical edge list and is used by every v4 logistics markdown. It intentionally reuses the same cross-domain edge names for logistics, payment gateway, banking, ERP/accounting, marketplace, and custom-source docs.
