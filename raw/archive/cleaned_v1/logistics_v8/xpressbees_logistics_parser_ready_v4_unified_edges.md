# XpressBees Logistics Knowledge — Parser Ready v4 Unified Edges
## 0. Document Metadata
```yaml
document_metadata:
  document_id: xpressbees_logistics_parser_ready_v4_unified_edges
  title: XpressBees Logistics Knowledge — Parser Ready v4 Unified Edges
  domain: logistics
  vendor: XpressBees
...
candidate_card:
  ...
  fields:
    ...
    implementations:
    - see metric_impl blocks in xpressbees_logistics_parser_ready_v3_expansive.md
    evidence_refs:
    - evidence.logistics_kb_doc
    - evidence.cognee_design_v4
    - evidence.unified_edge_scope
...
```yaml
review_item:
  id: review.xpressbees_logistics_parser_ready_v4_unified_edges.business_flow_boundary
