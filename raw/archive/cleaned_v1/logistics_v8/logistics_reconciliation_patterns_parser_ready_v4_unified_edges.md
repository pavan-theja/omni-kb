# Logistics Reconciliation Patterns — Parser Ready v4 Unified Edges
## 0. Document Metadata
```yaml
document_metadata:
  document_id: logistics_reconciliation_patterns_parser_ready_v4_unified_edges
  title: Logistics Reconciliation Patterns — Parser Ready v4 Unified Edges
  domain: logistics
...
```yaml
review_item:
  id: review.logistics_reconciliation_patterns_parser_ready_v4_unified_edges.business_flow_boundary
