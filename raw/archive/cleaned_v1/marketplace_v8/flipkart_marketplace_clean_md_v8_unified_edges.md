...
```yaml
document_metadata:
  document_id: flipkart_marketplace_clean_md_v8_unified_edges
  vendor: Flipkart
...
This V8 redraft keeps the Flipkart marketplace cards from the V3/V7 parser-ready markdown and replaces the edge layer with a unified taxonomy. The edge layer now supports:

- canonical uppercase edge types as the source of truth;
- legacy parser-helper aliases such as `column_belongs_to_table`, `implementation_uses_table`, `profile_expected_side`, and `side_uses_key_column`;
- explicit `inverse_edge_type` on every edge;
- `materialize_inverse` flags so the parser knows which reverse edges should be physically emitted;
- canonical-vs-parser-helper classification;
- role-bearing edge properties such as `side_role: expected` and `column_role: key`.

Edge count after unification: **889** candidate edges, including **21** materialized inverse edges.
...
- Treat scope-like fields such as `group_level_id` and `group_id` only as columns/caveats.
...
candidate_card:
  ...
  fields:
    ...
    marketplace_module: orders
    grain: order item / transaction row, review required
    primary_keys: 
      - order_id
      - item_id
    business_keys: 
    ...
    known_filters: 
      - is_active = true
    source_caveats: 
      - Source section labelled flipkart_oms repeats cashback-like descriptions; only partial OMS cards should be emitted.
    evidence_refs: 
...
candidate_card:
  ...
  fields:
    ...
    known_filters: 
      - is_active = true
    source_caveats: 
      - Granular fee columns can be null; mp_fee is more reliable for aggregate fee impact.
      - group_level_id value 66388 appears in settlement examples; do not treat as account binding.
    evidence_refs: 
      - evidence.flipkart.settlement
      - review.flipkart.settlement_schema_alias
    confidence: high
    review_status: accepted
```
...
candidate_card:
  ...
  fields:
    ...
    source_caveats: 
      ...
      - Use charged_amount and total_tax for decimal fee calculations; many legacy fee columns are strings.
    evidence_refs: 
...
candidate_card:
  ...
  fields:
    ...
    known_filters: 
      - is_active = true
    source_caveats: 
      - charged_amount is signed; forward/credit and reverse/cancel/debit semantics must not be flattened.
      - document_type and document_sub_type can be null and should be preserved.
    evidence_refs: 
...
candidate_card:
  ...
  fields:
    ...
    business_meaning: Order/row created date; used as settlement-cycle fallback when dispatch date is absent.
    metric_role: ''
    join_role: ''
    filter_role: ''
    source_caveats: []
...
candidate_card:
  ...
  fields:
    ...
    data_type: decimal
    semantic_type: vendor_payout_amount
    business_meaning: Marketplace payout amount field, not a bank-card field.
    metric_role: metric_amount
    join_role: ''
    filter_role: ''
    source_caveats: []
...
candidate_card:
  card_type: column
  card_id: column.settlement.report_end_date
  name: table.flipkart.settlement.report_end_date
  fields:
    table_id: table.flipkart.settlement
    column_name: report_end_date
    data_type: date
    semantic_type: report_end_date
    business_meaning: Report partition/end date.
    metric_role: ''
    join_role: ''
    filter_role: ''
    source_caveats: []
...
candidate_card:
  ...
  fields:
    ...
    column_name: tier
    data_type: string
    semantic_type: seller_tier_or_fee_tier
    business_meaning: Tier field if present; review semantics before seller-tier metrics.
    metric_role: ''
    join_role: ''
    filter_role: filter
    source_caveats: []
...
candidate_card:
  card_type: column
  card_id: column.commission.commission_rate
  name: table.flipkart.commission.commission_rate
  fields:
    table_id: table.flipkart.commission
    column_name: commission_rate
    data_type: string
    semantic_type: commission_rate
    business_meaning: Commission rate string; parse before numeric analysis.
    metric_role: ''
    join_role: ''
    filter_role: ''
    source_caveats: 
...
candidate_card:
  card_type: column
  card_id: column.commission.base_price
  name: table.flipkart.commission.base_price
  fields:
    table_id: table.flipkart.commission
    column_name: base_price
    data_type: string
    semantic_type: base_price
    business_meaning: Base price string; parse before numeric analysis.
    metric_role: metric_amount_caveat
    join_role: ''
    filter_role: ''
    source_caveats: 
...
candidate_card:
  card_type: column
  card_id: column.commission.rebate_amount
  name: table.flipkart.commission.rebate_amount
  fields:
    table_id: table.flipkart.commission
    column_name: rebate_amount
    data_type: decimal
    semantic_type: rebate_amount
    business_meaning: Fee rebate/waiver amount if populated.
    metric_role: metric_amount
    join_role: ''
    filter_role: ''
    source_caveats: []
...
candidate_card:
  card_type: column
  card_id: column.commission.insertion_date
  name: table.flipkart.commission.insertion_date
  fields:
    table_id: table.flipkart.commission
    column_name: insertion_date
    data_type: date
    semantic_type: insertion_date
    business_meaning: Ingestion/insertion date.
    metric_role: ''
    join_role: ''
    filter_role: ''
    source_caveats: []
...
candidate_card:
  card_type: column
  card_id: column.commission.report_end_date
  name: table.flipkart.commission.report_end_date
  fields:
    table_id: table.flipkart.commission
    column_name: report_end_date
    data_type: date
    semantic_type: report_end_date
    business_meaning: Report period end date.
    metric_role: ''
    join_role: ''
    filter_role: ''
    source_caveats: []
...
candidate_card:
  card_type: column
  card_id: column.cashback.posted_date
  name: table.flipkart.cashback.posted_date
  fields:
    table_id: table.flipkart.cashback
    column_name: posted_date
    data_type: date
    semantic_type: posted_date
    business_meaning: Posted date for credit/debit note.
    metric_role: ''
    join_role: ''
    filter_role: ''
    source_caveats: []
...
candidate_card:
  card_type: column
  card_id: column.cashback.order_date
  name: table.flipkart.cashback.order_date
  fields:
    table_id: table.flipkart.cashback
    column_name: order_date
    data_type: date
    semantic_type: order_date
    business_meaning: Order date if present.
    metric_role: ''
    join_role: ''
    filter_role: ''
    source_caveats: []
...
candidate_card:
  card_type: column
  card_id: column.cashback.buyer_gstin
  name: table.flipkart.cashback.buyer_gstin
  fields:
    table_id: table.flipkart.cashback
    column_name: buyer_gstin
    data_type: string
    semantic_type: buyer_gstin
    business_meaning: Buyer GSTIN field; marketplace column only, not tax filing.
    metric_role: ''
    join_role: ''
    filter_role: ''
    source_caveats: []
...
candidate_card:
  ...
  fields:
    ...
    known_values: 
      ...
      - Collection Fee
    value_meanings: Fee class controls detailed fee metrics and fee breakdown queries.
...
candidate_card:
  ...
  fields:
    ...
    known_values: 
      ...
      - reverse
      - forward cancel
    value_meanings: Forward, reverse, and cancellation semantics control sign and grouping.
    null_semantics: preserve nulls where observed
    normalization: case/source-value preserving unless query pattern says otherwise
    evidence_refs: 
      - evidence.flipkart.cashback
...
candidate_card:
  ...
  fields:
    ...
    known_values: 
      ...
      - Debit Note
      - null
    value_meanings: Credit/debit note type; null is a valid observed value.
    null_semantics: preserve nulls where observed
    normalization: case/source-value preserving unless query pattern says otherwise
    evidence_refs: 
      - evidence.flipkart.cashback
...
candidate_card:
  ...
  fields:
    ...
    known_values: 
      ...
      - Cancellation
      - null
    value_meanings: Credit/debit note subtype; null is a valid observed value.
    null_semantics: preserve nulls where observed
    normalization: case/source-value preserving unless query pattern says otherwise
    evidence_refs: 
      - evidence.flipkart.cashback
...
candidate_card:
  ...
  fields:
    ...
    known_values: 
      - 'true'
      - 'false'
    value_meanings: String-valued Shopsy flag.
    null_semantics: preserve nulls where observed
    normalization: case/source-value preserving unless query pattern says otherwise
    evidence_refs: 
      - evidence.flipkart.cashback
...
candidate_card:
  ...
  fields:
    ...
    known_values: 
      - FBF
      - NON_FBF
    value_meanings: OMS fulfilment naming, partial confidence.
    null_semantics: preserve nulls where observed
    normalization: case/source-value preserving unless query pattern says otherwise
    evidence_refs: 
      - evidence.flipkart.cashback
...
candidate_card:
  ...
  fields:
    ...
    known_values: 
      - flipkart_fulfilment
      - seller_easy_ship
    value_meanings: Settlement fulfilment naming; map semantically to FBF/NFBF where needed.
    null_semantics: preserve nulls where observed
    normalization: case/source-value preserving unless query pattern says otherwise
    evidence_refs: 
      - evidence.flipkart.cashback
...
candidate_card:
  ...
  fields:
    ...
    value_meanings: Settlement payment/cycle classification; source values should be preserved.
    null_semantics: preserve nulls where observed
    normalization: case/source-value preserving unless query pattern says otherwise
    evidence_refs: 
      - evidence.flipkart.cashback
...
candidate_card:
  ...
  fields:
    ...
    known_values: 
      ...
      - cancel
      - source-specific
    value_meanings: Return/reverse type classification; preserve source values.
    null_semantics: preserve nulls where observed
    normalization: case/source-value preserving unless query pattern says otherwise
    evidence_refs: 
      - evidence.flipkart.cashback
...
candidate_card:
  ...
  fields:
    ...
    value_meanings: Scope key values vary by table; never infer account binding from this marketplace doc.
    null_semantics: preserve nulls where observed
    normalization: case/source-value preserving unless query pattern says otherwise
    evidence_refs: 
      - evidence.flipkart.cashback
...
candidate_card:
  ...
  fields:
    ...
    implementation_caveats: 
      - OMS schema partial; use only after review.
    sql_pattern_ref: see sql registry
    evidence_refs: 
      - evidence.flipkart.query_patterns
    confidence: medium
    review_status: review_required
...
candidate_card:
  ...
  fields:
    ...
    source_columns: 
      ...
      - oms.charged_amount
    formula: SUM(cashback.charged_amount) / NULLIF(SUM(oms.charged_amount), 0)
    filters: 
      - is_active = true on both tables
    grain: order/item after cashback aggregation
    time_basis: created_date/post_date
    sign_handling: preserve source sign unless formula explicitly uses ABS for reporting ratio
    aggregation_rule: aggregate at declared grain before joins
    join_dependencies: 
      - see relationship cards when cross-table
    metric_pattern: platform-specific implementation of generic colloquial metric
    implementation_caveats: 
      - OMS schema partial; review before production.
    sql_pattern_ref: see sql registry
    evidence_refs: 
      - evidence.flipkart.query_patterns
    confidence: medium
...
candidate_card:
  ...
  fields:
    ...
    source_columns: 
      - return_type
      - order_id
    formula: COUNT(DISTINCT CASE WHEN return_type IS NOT NULL THEN order_id END) / NULLIF(COUNT(DISTINCT order_id), 0)
    filters: 
      - is_active = true
    grain: order
    time_basis: settlement_date
    ...
    metric_pattern: platform-specific implementation of generic colloquial metric
    implementation_caveats: 
      - Review source return_type values before final taxonomy.
    sql_pattern_ref: see sql registry
    evidence_refs: 
      - evidence.flipkart.query_patterns
    confidence: medium
...
candidate_card:
  ...
  fields:
    ...
    source_columns: 
      - document_sub_type
      - order_id
    formula: COUNT(DISTINCT CASE WHEN document_sub_type = Cancellation THEN order_id END) / NULLIF(COUNT(DISTINCT order_id), 0)
    filters: 
      - is_active = true
    grain: order
    time_basis: posted_date
    ...
    metric_pattern: platform-specific implementation of generic colloquial metric
    implementation_caveats: 
      - Cashback document_sub_type is one cancellation signal, not full OMS cancellation truth.
    sql_pattern_ref: see sql registry
    evidence_refs: 
      - evidence.flipkart.query_patterns
    confidence: medium
...
candidate_card:
  ...
  fields:
    ...
    inputs: 
      ...
      - total_tcs_amount
      - total_tds_amount
    formula: Component sum should reconcile to settled_amount after source sign conventions are confirmed.
    semantic_constraints: 
      - Sign conventions require review before hard validation.
    sign_handling: source-sign preserving unless stated otherwise
    evidence_refs: 
      - evidence.flipkart.query_patterns
    confidence: medium
...
candidate_card:
  ...
  fields:
    process_name: Forward order to settlement
    marketplace_module: Flipkart marketplace
    trigger_event: order creation / forward transaction
    start_state: source marketplace event
    end_state: settled marketplace payout
...
candidate_card:
  ...
  fields:
    process_name: Return/cancel reversal
    marketplace_module: Flipkart marketplace
    trigger_event: return or cancellation signal
    start_state: source marketplace event
    end_state: refund/reverse settlement or debit/credit note
    participating_tables: 
      - table.flipkart.oms
      - table.flipkart.settlement
      - table.flipkart.commission
...
candidate_card:
  ...
  fields:
    process_name: Commission fee invoice
    marketplace_module: Flipkart marketplace
    trigger_event: marketplace fee assessment
    start_state: source marketplace event
    end_state: fee invoice lines and mp_fee settlement impact
    participating_tables: 
      - table.flipkart.oms
      - table.flipkart.settlement
      - table.flipkart.commission
...
candidate_card:
  ...
  fields:
    process_name: Cashback credit/debit note
    marketplace_module: Flipkart marketplace
    trigger_event: promotion/offer/credit-debit event
    start_state: source marketplace event
    end_state: cashback/offer settlement impact
    participating_tables: 
      - table.flipkart.oms
      - table.flipkart.settlement
      - table.flipkart.commission
...
candidate_card:
  card_type: business_process
  card_id: business_process.flipkart.fulfilment_model_selection
  name: Fulfilment model selection
  fields:
    process_name: Fulfilment model selection
    marketplace_module: Flipkart marketplace
    trigger_event: fulfilment model assigned
    start_state: source marketplace event
    end_state: fee and settlement behavior changes
    participating_tables: 
      - table.flipkart.oms
      - table.flipkart.settlement
      - table.flipkart.commission
...
candidate_card:
  card_type: business_process
  card_id: business_process.flipkart.seller_tier_payout
  name: Seller tier payout cycle
  fields:
    process_name: Seller tier payout cycle
    marketplace_module: Flipkart marketplace
    trigger_event: seller tier/payment cycle context
    start_state: source marketplace event
    end_state: settlement timing/NEFT behavior
    participating_tables: 
      - table.flipkart.oms
      - table.flipkart.settlement
      - table.flipkart.commission
...
candidate_card:
  ...
  fields:
    process_name: Marketplace reconciliation pipeline
    marketplace_module: Flipkart marketplace
    trigger_event: marketplace tables available
    start_state: source marketplace event
    end_state: matched financial truth across orders, fees, cashback, settlement
    participating_tables: 
      - table.flipkart.oms
      - table.flipkart.settlement
      - table.flipkart.commission
...
candidate_card:
  ...
  fields:
    ...
    step_order: 1
    step_name: Capture order item
    trigger: source row available
    input_tables: 
      - Flipkart marketplace source tables
    output_semantics: OMS/settlement order id and item id become the core unit
    required_keys: 
      - order_id
      - item_id
    important_columns: 
...
candidate_card:
  ...
  fields:
    process_id: business_process.flipkart.forward_order_to_settlement
    step_order: 2
    step_name: Capture settlement line
    trigger: source row available
    input_tables: 
      - Flipkart marketplace source tables
    output_semantics: settled_amount and sale/refund/offer fields become payout facts
    required_keys: 
      - order_id
      - item_id
    important_columns: 
...
candidate_card:
  ...
  fields:
    ...
    input_tables: 
      - Flipkart marketplace source tables
    output_semantics: commission table fee lines by description are recorded
    required_keys: 
      - order_id
      - item_id
    important_columns: 
...
candidate_card:
  ...
  fields:
    ...
    input_tables: 
      - Flipkart marketplace source tables
    output_semantics: commission fee lines are grouped by order_id,item_id and fee class
    required_keys: 
      - order_id
      - item_id
    important_columns: 
...
candidate_card:
  ...
  fields:
    ...
    input_tables: 
      - Flipkart marketplace source tables
    output_semantics: cashback charged_amount, document type/subtype, transaction type are recorded
    required_keys: 
      - order_id
      - item_id
    important_columns: 
...
candidate_card:
  ...
  fields:
    ...
    input_tables: 
      - Flipkart marketplace source tables
    output_semantics: cashback rows are grouped by order_id,item_id before reconciliation
    required_keys: 
      - order_id
      - item_id
    important_columns: 
...
candidate_card:
  ...
  fields:
    ...
    step_order: 1
    step_name: Reconcile settlement to source concepts
    trigger: source row available
    input_tables: 
      - Flipkart marketplace source tables
    output_semantics: compare OMS/order value, fee detail, and cashback/offer impact to settlement
    required_keys: 
      - order_id
      - item_id
    important_columns: 
...
candidate_card:
  ...
  fields:
    process_id: business_process.flipkart.marketplace_reconciliation_pipeline
    step_order: 2
    step_name: Output exceptions
    trigger: source row available
    input_tables: 
      - Flipkart marketplace source tables
    output_semantics: report missing lines, amount mismatches, fee variance, cashback mismatch, and normalization failures
    required_keys: 
      - order_id
      - item_id
    important_columns: 
...
candidate_card:
  ...
  card_id: state_transition.flipkart.fulfilment.fbf_to_settlement
  name: Flipkart fulfilment.fbf_to_settlement
  fields:
    process_id: business_process.flipkart.fulfilment_model_selection
    from_state: FBF
    to_state: flipkart_fulfilment
    trigger: source value or aggregation
    evidence_column: fulfilment_type/document_sub_type/transaction_type/description
    business_effect: fulfilment_type mapping affects fee/settlement analysis
    evidence_refs: 
      - evidence.flipkart.fulfilment
      - evidence.flipkart.cashback
      - evidence.flipkart.relationships
...
candidate_card:
  card_type: state_transition
  card_id: state_transition.flipkart.fulfilment.non_fbf_to_settlement
  name: Flipkart fulfilment.non_fbf_to_settlement
  fields:
    process_id: business_process.flipkart.fulfilment_model_selection
    from_state: NON_FBF
    to_state: seller_easy_ship
    trigger: source value or aggregation
    evidence_column: fulfilment_type/document_sub_type/transaction_type/description
    business_effect: fulfilment_type mapping affects fee/settlement analysis
    evidence_refs: 
...
candidate_card:
  ...
  fields:
    process_id: business_process.flipkart.cashback_credit_debit_note
    from_state: Sale / Credit Note
    to_state: Return / Debit Note
    trigger: source value or aggregation
    evidence_column: fulfilment_type/document_sub_type/transaction_type/description
    business_effect: cashback reversal or negative impact
    evidence_refs: 
      - evidence.flipkart.fulfilment
      - evidence.flipkart.cashback
      - evidence.flipkart.relationships
...
candidate_card:
  ...
  fields:
    process_id: business_process.flipkart.cashback_credit_debit_note
    from_state: forward
    to_state: forward cancel
    trigger: source value or aggregation
    evidence_column: fulfilment_type/document_sub_type/transaction_type/description
    business_effect: cancelled cashback/offer impact
    evidence_refs: 
      - evidence.flipkart.fulfilment
      - evidence.flipkart.cashback
      - evidence.flipkart.relationships
...
candidate_card:
  card_type: state_transition
  card_id: state_transition.flipkart.fee_detail_to_mp_fee
  name: Flipkart fee_detail_to_mp_fee
  fields:
    process_id: business_process.flipkart.commission_fee_invoice
    from_state: fee detail lines
    to_state: settlement mp_fee aggregate
    trigger: source value or aggregation
    evidence_column: fulfilment_type/document_sub_type/transaction_type/description
    business_effect: fee detail should reconcile to settlement fee impact after normalization
    evidence_refs: 
      - evidence.flipkart.fulfilment
      - evidence.flipkart.cashback
      - evidence.flipkart.relationships
...
candidate_card:
  ...
  card_id: process_variant.flipkart.fbf_vs_nfbf
  name: Flipkart fbf_vs_nfbf
  fields:
    base_process: business_process.flipkart.fulfilment_model_selection
    variant_condition: FBF/NON_FBF or flipkart_fulfilment/seller_easy_ship
    variant_effect: fulfilment affects fee and payout analysis
    affected_metrics: 
      - realization_rate
      - effective_fee_rate
      - settlement_cycle_days
    affected_reconciliation: 
      - settlement and fee/cashback profiles
    evidence_refs: 
      - evidence.flipkart.fulfilment
      - evidence.flipkart.shopsy
    confidence: high
...
candidate_card:
  card_type: process_variant
  card_id: process_variant.flipkart.prepaid_vs_postpaid
  name: Flipkart prepaid_vs_postpaid
  fields:
    base_process: business_process.flipkart.forward_order_to_settlement
    variant_condition: neft_type / payment cycle classification
    variant_effect: settlement grouping and payout-cycle analysis changes
    affected_metrics: 
      - realization_rate
      - effective_fee_rate
      - settlement_cycle_days
...
candidate_card:
  card_type: process_variant
  card_id: process_variant.flipkart.shopsy
  name: Flipkart shopsy
  fields:
    base_process: business_process.flipkart.cashback_credit_debit_note
    variant_condition: is_shopsy_order_ = true
    variant_effect: Shopsy-specific cashback/commission expectations may differ
    affected_metrics: 
      - realization_rate
      - effective_fee_rate
      - settlement_cycle_days
...
candidate_card:
  card_type: process_variant
  card_id: process_variant.flipkart.seller_tier_payout
  name: Flipkart seller_tier_payout
  fields:
    base_process: business_process.flipkart.seller_tier_payout
    variant_condition: seller tier/payment-cycle context
    variant_effect: Settlement cycle may differ; source column needs review
    affected_metrics: 
      - realization_rate
      - effective_fee_rate
      - settlement_cycle_days
...
candidate_card:
  ...
  fields:
    ...
    pre_aggregation: aggregate commission/cashback details before joining
    comparison_formula: compare component formula to settled_amount
    tolerance: review_required
    date_window: review required
    failure_modes: 
      - missing key
...
candidate_card:
  ...
  fields:
    ...
    group_by_options: 
      ...
      - document_type
      - is_shopsy_order_
    time_basis: settlement_date for settlement, posted_date for cashback, created_date fallback for OMS/commission
    join_requirements: 
...
```yaml
candidate_edge:
  edge_id: edge.table.flipkart.settlement.has_column.column.settlement.report_end_date
  edge_type: HAS_COLUMN
  source: table.flipkart.settlement
  target: column.settlement.report_end_date
  fields:
    edge_family: data_understanding
    evidence_basis: column.fields.table_id
    confidence: high
...
```yaml
candidate_edge:
  edge_id: edge.column.settlement.report_end_date.belongs_to_table.table.flipkart.settlement
  edge_type: BELONGS_TO_TABLE
  source: column.settlement.report_end_date
  target: table.flipkart.settlement
  fields:
    edge_family: data_understanding
    evidence_basis: column.fields.table_id
...
```yaml
candidate_edge:
  edge_id: edge.table.flipkart.commission.has_column.column.commission.commission_rate
  edge_type: HAS_COLUMN
  source: table.flipkart.commission
  target: column.commission.commission_rate
  fields:
    edge_family: data_understanding
    evidence_basis: column.fields.table_id
    confidence: high
...
```yaml
candidate_edge:
  edge_id: edge.column.commission.commission_rate.belongs_to_table.table.flipkart.commission
  edge_type: BELONGS_TO_TABLE
  source: column.commission.commission_rate
  target: table.flipkart.commission
  fields:
    edge_family: data_understanding
    evidence_basis: column.fields.table_id
...
```yaml
candidate_edge:
  edge_id: edge.table.flipkart.commission.has_column.column.commission.base_price
  edge_type: HAS_COLUMN
  source: table.flipkart.commission
  target: column.commission.base_price
  fields:
    edge_family: data_understanding
    evidence_basis: column.fields.table_id
    confidence: high
...
```yaml
candidate_edge:
  edge_id: edge.column.commission.base_price.belongs_to_table.table.flipkart.commission
  edge_type: BELONGS_TO_TABLE
  source: column.commission.base_price
  target: table.flipkart.commission
  fields:
    edge_family: data_understanding
    evidence_basis: column.fields.table_id
...
```yaml
candidate_edge:
  edge_id: edge.table.flipkart.commission.has_column.column.commission.rebate_amount
  edge_type: HAS_COLUMN
  source: table.flipkart.commission
  target: column.commission.rebate_amount
  fields:
    edge_family: data_understanding
    evidence_basis: column.fields.table_id
    confidence: high
...
```yaml
candidate_edge:
  edge_id: edge.column.commission.rebate_amount.belongs_to_table.table.flipkart.commission
  edge_type: BELONGS_TO_TABLE
  source: column.commission.rebate_amount
  target: table.flipkart.commission
  fields:
    edge_family: data_understanding
    evidence_basis: column.fields.table_id
...
```yaml
candidate_edge:
  edge_id: edge.table.flipkart.commission.has_column.column.commission.insertion_date
  edge_type: HAS_COLUMN
  source: table.flipkart.commission
  target: column.commission.insertion_date
  fields:
    edge_family: data_understanding
    evidence_basis: column.fields.table_id
    confidence: high
...
```yaml
candidate_edge:
  edge_id: edge.column.commission.insertion_date.belongs_to_table.table.flipkart.commission
  edge_type: BELONGS_TO_TABLE
  source: column.commission.insertion_date
  target: table.flipkart.commission
  fields:
    edge_family: data_understanding
    evidence_basis: column.fields.table_id
...
```yaml
candidate_edge:
  edge_id: edge.table.flipkart.commission.has_column.column.commission.report_end_date
  edge_type: HAS_COLUMN
  source: table.flipkart.commission
  target: column.commission.report_end_date
  fields:
    edge_family: data_understanding
    evidence_basis: column.fields.table_id
    confidence: high
...
```yaml
candidate_edge:
  edge_id: edge.column.commission.report_end_date.belongs_to_table.table.flipkart.commission
  edge_type: BELONGS_TO_TABLE
  source: column.commission.report_end_date
  target: table.flipkart.commission
  fields:
    edge_family: data_understanding
    evidence_basis: column.fields.table_id
...
```yaml
candidate_edge:
  edge_id: edge.table.flipkart.cashback.has_column.column.cashback.posted_date
  edge_type: HAS_COLUMN
  source: table.flipkart.cashback
  target: column.cashback.posted_date
  fields:
    edge_family: data_understanding
    evidence_basis: column.fields.table_id
    confidence: high
...
```yaml
candidate_edge:
  edge_id: edge.column.cashback.posted_date.belongs_to_table.table.flipkart.cashback
  edge_type: BELONGS_TO_TABLE
  source: column.cashback.posted_date
  target: table.flipkart.cashback
  fields:
    edge_family: data_understanding
    evidence_basis: column.fields.table_id
...
```yaml
candidate_edge:
  edge_id: edge.table.flipkart.cashback.has_column.column.cashback.order_date
  edge_type: HAS_COLUMN
  source: table.flipkart.cashback
  target: column.cashback.order_date
  fields:
    edge_family: data_understanding
    evidence_basis: column.fields.table_id
    confidence: high
...
```yaml
candidate_edge:
  edge_id: edge.column.cashback.order_date.belongs_to_table.table.flipkart.cashback
  edge_type: BELONGS_TO_TABLE
  source: column.cashback.order_date
  target: table.flipkart.cashback
  fields:
    edge_family: data_understanding
    evidence_basis: column.fields.table_id
...
```yaml
candidate_edge:
  edge_id: edge.table.flipkart.cashback.has_column.column.cashback.buyer_gstin
  edge_type: HAS_COLUMN
  source: table.flipkart.cashback
  target: column.cashback.buyer_gstin
  fields:
    edge_family: data_understanding
    evidence_basis: column.fields.table_id
    confidence: high
...
```yaml
candidate_edge:
  edge_id: edge.column.cashback.buyer_gstin.belongs_to_table.table.flipkart.cashback
  edge_type: BELONGS_TO_TABLE
  source: column.cashback.buyer_gstin
  target: table.flipkart.cashback
  fields:
    edge_family: data_understanding
    evidence_basis: column.fields.table_id
...
```yaml
candidate_edge:
  edge_id: edge.domain.marketplace.flipkart.fulfilment.has_business_process.business_process.flipkart.fulfilment_model_selection
  edge_type: HAS_BUSINESS_PROCESS
  source: domain.marketplace.flipkart.fulfilment
  target: business_process.flipkart.fulfilment_model_selection
  fields:
    edge_family: process_understanding
    evidence_basis: deterministic process/domain semantic mapping
    confidence: high
...
```yaml
candidate_edge:
  edge_id: edge.business_process.flipkart.fulfilment_model_selection.belongs_to_domain.domain.marketplace.flipkart.fulfilment
  edge_type: BELONGS_TO_DOMAIN
  source: business_process.flipkart.fulfilment_model_selection
  target: domain.marketplace.flipkart.fulfilment
  fields:
    edge_family: process_understanding
    evidence_basis: deterministic process/domain semantic mapping
    confidence: high
...
```yaml
candidate_edge:
  edge_id: edge.domain.marketplace.flipkart.settlement.has_business_process.business_process.flipkart.seller_tier_payout
  edge_type: HAS_BUSINESS_PROCESS
  source: domain.marketplace.flipkart.settlement
  target: business_process.flipkart.seller_tier_payout
  fields:
    edge_family: process_understanding
    evidence_basis: deterministic process/domain semantic mapping
    confidence: high
...
```yaml
candidate_edge:
  edge_id: edge.business_process.flipkart.seller_tier_payout.belongs_to_domain.domain.marketplace.flipkart.settlement
  edge_type: BELONGS_TO_DOMAIN
  source: business_process.flipkart.seller_tier_payout
  target: domain.marketplace.flipkart.settlement
  fields:
    edge_family: process_understanding
    evidence_basis: deterministic process/domain semantic mapping
...
```yaml
candidate_edge:
  edge_id: edge.business_process.flipkart.fulfilment_model_selection.uses_table.table.flipkart.oms
  edge_type: USES_TABLE
  source: business_process.flipkart.fulfilment_model_selection
  target: table.flipkart.oms
  fields:
...
```yaml
candidate_edge:
  edge_id: edge.business_process.flipkart.fulfilment_model_selection.uses_table.table.flipkart.settlement
  edge_type: USES_TABLE
  source: business_process.flipkart.fulfilment_model_selection
  target: table.flipkart.settlement
  fields:
...
```yaml
candidate_edge:
  edge_id: edge.business_process.flipkart.fulfilment_model_selection.uses_table.table.flipkart.commission
  edge_type: USES_TABLE
  source: business_process.flipkart.fulfilment_model_selection
  target: table.flipkart.commission
  fields:
...
```yaml
candidate_edge:
  edge_id: edge.business_process.flipkart.fulfilment_model_selection.uses_table.table.flipkart.cashback
  edge_type: USES_TABLE
  source: business_process.flipkart.fulfilment_model_selection
  target: table.flipkart.cashback
  fields:
...
```yaml
candidate_edge:
  edge_id: edge.business_process.flipkart.seller_tier_payout.uses_table.table.flipkart.oms
  edge_type: USES_TABLE
  source: business_process.flipkart.seller_tier_payout
  target: table.flipkart.oms
  fields:
...
```yaml
candidate_edge:
  edge_id: edge.business_process.flipkart.seller_tier_payout.uses_table.table.flipkart.settlement
  edge_type: USES_TABLE
  source: business_process.flipkart.seller_tier_payout
  target: table.flipkart.settlement
  fields:
...
```yaml
candidate_edge:
  edge_id: edge.business_process.flipkart.seller_tier_payout.uses_table.table.flipkart.commission
  edge_type: USES_TABLE
  source: business_process.flipkart.seller_tier_payout
  target: table.flipkart.commission
  fields:
...
```yaml
candidate_edge:
  edge_id: edge.business_process.flipkart.seller_tier_payout.uses_table.table.flipkart.cashback
  edge_type: USES_TABLE
  source: business_process.flipkart.seller_tier_payout
  target: table.flipkart.cashback
  fields:
...
```yaml
candidate_edge:
  edge_id: edge.business_process.flipkart.fulfilment_model_selection.has_state_transition.state_transition.flipkart.fulfilment.fbf_to_settlement
  edge_type: HAS_STATE_TRANSITION
  source: business_process.flipkart.fulfilment_model_selection
  target: state_transition.flipkart.fulfilment.fbf_to_settlement
  fields:
    edge_family: process_understanding
...
```yaml
candidate_edge:
  edge_id: edge.state_transition.flipkart.fulfilment.fbf_to_settlement.belongs_to_process.business_process.flipkart.fulfilment_model_selection
  edge_type: BELONGS_TO_PROCESS
  source: state_transition.flipkart.fulfilment.fbf_to_settlement
  target: business_process.flipkart.fulfilment_model_selection
  fields:
    edge_family: process_understanding
    evidence_basis: state_transition.fields.process_id
...
```yaml
candidate_edge:
  edge_id: edge.business_process.flipkart.fulfilment_model_selection.has_state_transition.state_transition.flipkart.fulfilment.non_fbf_to_settlement
  edge_type: HAS_STATE_TRANSITION
  source: business_process.flipkart.fulfilment_model_selection
  target: state_transition.flipkart.fulfilment.non_fbf_to_settlement
  fields:
    edge_family: process_understanding
    evidence_basis: state_transition.fields.process_id
    confidence: high
...
```yaml
candidate_edge:
  edge_id: edge.state_transition.flipkart.fulfilment.non_fbf_to_settlement.belongs_to_process.business_process.flipkart.fulfilment_model_selection
  edge_type: BELONGS_TO_PROCESS
  source: state_transition.flipkart.fulfilment.non_fbf_to_settlement
  target: business_process.flipkart.fulfilment_model_selection
  fields:
    edge_family: process_understanding
    evidence_basis: state_transition.fields.process_id
...
```yaml
candidate_edge:
  edge_id: edge.business_process.flipkart.commission_fee_invoice.has_state_transition.state_transition.flipkart.fee_detail_to_mp_fee
  edge_type: HAS_STATE_TRANSITION
  source: business_process.flipkart.commission_fee_invoice
  target: state_transition.flipkart.fee_detail_to_mp_fee
  fields:
    edge_family: process_understanding
    evidence_basis: state_transition.fields.process_id
    confidence: high
...
```yaml
candidate_edge:
  edge_id: edge.state_transition.flipkart.fee_detail_to_mp_fee.belongs_to_process.business_process.flipkart.commission_fee_invoice
  edge_type: BELONGS_TO_PROCESS
  source: state_transition.flipkart.fee_detail_to_mp_fee
  target: business_process.flipkart.commission_fee_invoice
  fields:
    edge_family: process_understanding
    evidence_basis: state_transition.fields.process_id
...
```yaml
candidate_edge:
  edge_id: edge.business_process.flipkart.fulfilment_model_selection.has_process_variant.process_variant.flipkart.fbf_vs_nfbf
  edge_type: HAS_PROCESS_VARIANT
  source: business_process.flipkart.fulfilment_model_selection
  target: process_variant.flipkart.fbf_vs_nfbf
  fields:
    edge_family: process_understanding
    evidence_basis: process_variant.fields.base_process
    confidence: high
    canonical_cognee_edge: true
    marketplace_only: true
...
```yaml
candidate_edge:
  edge_id: edge.process_variant.flipkart.fbf_vs_nfbf.extends_process.business_process.flipkart.fulfilment_model_selection
  edge_type: EXTENDS_PROCESS
  source: process_variant.flipkart.fbf_vs_nfbf
  target: business_process.flipkart.fulfilment_model_selection
  fields:
    edge_family: process_understanding
    evidence_basis: process_variant.fields.base_process
...
```yaml
candidate_edge:
  edge_id: edge.business_process.flipkart.forward_order_to_settlement.has_process_variant.process_variant.flipkart.prepaid_vs_postpaid
  edge_type: HAS_PROCESS_VARIANT
  source: business_process.flipkart.forward_order_to_settlement
  target: process_variant.flipkart.prepaid_vs_postpaid
  fields:
    edge_family: process_understanding
    evidence_basis: process_variant.fields.base_process
    confidence: high
...
```yaml
candidate_edge:
  edge_id: edge.process_variant.flipkart.prepaid_vs_postpaid.extends_process.business_process.flipkart.forward_order_to_settlement
  edge_type: EXTENDS_PROCESS
  source: process_variant.flipkart.prepaid_vs_postpaid
  target: business_process.flipkart.forward_order_to_settlement
  fields:
    edge_family: process_understanding
    evidence_basis: process_variant.fields.base_process
...
```yaml
candidate_edge:
  edge_id: edge.business_process.flipkart.cashback_credit_debit_note.has_process_variant.process_variant.flipkart.shopsy
  edge_type: HAS_PROCESS_VARIANT
  source: business_process.flipkart.cashback_credit_debit_note
  target: process_variant.flipkart.shopsy
  fields:
    edge_family: process_understanding
    evidence_basis: process_variant.fields.base_process
    confidence: high
...
```yaml
candidate_edge:
  edge_id: edge.process_variant.flipkart.shopsy.extends_process.business_process.flipkart.cashback_credit_debit_note
  edge_type: EXTENDS_PROCESS
  source: process_variant.flipkart.shopsy
  target: business_process.flipkart.cashback_credit_debit_note
  fields:
    edge_family: process_understanding
    evidence_basis: process_variant.fields.base_process
...
```yaml
candidate_edge:
  edge_id: edge.business_process.flipkart.seller_tier_payout.has_process_variant.process_variant.flipkart.seller_tier_payout
  edge_type: HAS_PROCESS_VARIANT
  source: business_process.flipkart.seller_tier_payout
  target: process_variant.flipkart.seller_tier_payout
  fields:
    edge_family: process_understanding
    evidence_basis: process_variant.fields.base_process
    confidence: high
...
```yaml
candidate_edge:
  edge_id: edge.process_variant.flipkart.seller_tier_payout.extends_process.business_process.flipkart.seller_tier_payout
  edge_type: EXTENDS_PROCESS
  source: process_variant.flipkart.seller_tier_payout
  target: business_process.flipkart.seller_tier_payout
  fields:
    edge_family: process_understanding
    evidence_basis: process_variant.fields.base_process
...
```yaml
candidate_edge:
  edge_id: edge.business_process.flipkart.seller_tier_payout.uses_metric.metric.settlement_cycle_days
  edge_type: USES_METRIC
  source: business_process.flipkart.seller_tier_payout
  target: metric.settlement_cycle_days
  fields:
...
```yaml
candidate_edge:
  edge_id: edge.metric.settlement_cycle_days.used_in_process.business_process.flipkart.seller_tier_payout
  edge_type: USED_IN_PROCESS
  source: metric.settlement_cycle_days
  target: business_process.flipkart.seller_tier_payout
  fields:
...
```yaml
candidate_edge:
  edge_id: edge.business_process.flipkart.seller_tier_payout.uses_metric.metric.net_settlement
  edge_type: USES_METRIC
  source: business_process.flipkart.seller_tier_payout
  target: metric.net_settlement
  fields:
...
```yaml
candidate_edge:
  edge_id: edge.metric.net_settlement.used_in_process.business_process.flipkart.seller_tier_payout
  edge_type: USED_IN_PROCESS
  source: metric.net_settlement
  target: business_process.flipkart.seller_tier_payout
  fields:
...
review_item:
  ...
  deterministic_action: Create only partial/medium-confidence OMS table, column, process, and metric implementation cards. Do not invent missing OMS fields.
...
review_item:
  ...
  deterministic_action: Use zs_observe.flipkart_settlement as primary table, record zs_refined as source alias/caveat.
...
review_item:
  ...
  deterministic_action: Use created_date as deterministic fallback and mark dispatch-date dependency as review-required.
...
review_item:
  ...
  deterministic_action: Represent seller tier as process/value caveat and do not require metric implementations unless a tier column exists.
  affected_cards: process_variant.flipkart.seller_tier_payout
```
...
review_item:
  ...
  deterministic_action: Do not create net margin metric implementation from Flipkart marketplace DOCX alone.
...
review_item:
  ...
  deterministic_action: Use 0.01 only where source SQL shows it; otherwise use review-required tolerance.
  affected_cards: reconciliation profiles
```
...
review_item:
  ...
  deterministic_action: Keep null as known value and do not coerce to Unknown unless downstream parser requires display normalization.
  affected_cards: value_profile.flipkart.cashback.document_type
```
...
review_item:
  ...
  deterministic_action: Treat group fields as columns/caveats only.
...
Total candidate cards: **293**  
Total candidate edges: **889**  
Evidence items: **10**  
Review items: **8**  
SQL patterns: **12**
